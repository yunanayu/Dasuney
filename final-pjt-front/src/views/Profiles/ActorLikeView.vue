<template>
  <div class="container">
    <h1 class="pageTitle">{{ route.params.username }}님이 좋아하는 배우</h1>
    <h6 class="subtitle">배우를 클릭하면 출연작을 볼 수 있어요</h6>
    <div class="array">
      <LikeActor v-for="actor in LikeActors" :key="actor.actor_id" :actor="actor"/>
    </div>
  </div>
</template>
